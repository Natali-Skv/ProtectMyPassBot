...
user_id_sequence = box.schema.sequence.create('user_id_sequence', {if_not_exists=true})
...
box.schema.func.create('get_user_creds', {language = 'LUA',if_not_exists=true})
...
box.schema.func.create('add_user_service',  {language = 'LUA',if_not_exists=true})
...
box.schema.func.create('remove_user_service', {language = 'LUA',if_not_exists=true})
...
box.schema.func.create('add_user', {language = 'LUA',if_not_exists=true})
